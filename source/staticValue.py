...
_output_field=[{'teamId':'Team name'},{'name':'Iteration name'},{'startDate':'Iteration start date'},{'endDate':'Iteration end date'},{'deliveredStories':'Stories/Cards/Tickets-Delivered'},{'storyPointsDelivered':'Story points delivered'},{'committedStoryPoints':'Story points - Committed'},{'deployments':'Deployments this iteration'},{'defectsStartBal':'Opening balance'},{'defects':'New this iteration'},{'defectsClosed':'Resolved this iteration'},{'defectsEndBal':'Closing balance'},{'cycleTimeInBacklog':'Cycle time in backlog (days)'},{'cycleTimeWIP':'Cycle time in WIP (days)'},{'memberCount':'Team members this iteration'},{'teamSatisfaction':'Team satisfaction'},{'clientSatisfaction':'Client satisfaction'},{'comment':'Comment about this iteration'},{'createdBy':'Created By'},{'createDate':'Create Date'},{'Sub-domain':'Sub-domain'},{'Tribe':'Tribe'}]
